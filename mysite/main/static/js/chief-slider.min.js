...
return!1;window.CustomEvent=function(t,i){i=i||{bubbles:!1,cancelable:!1,detail:null};
...
var r=this._$itemList,a=r[0].offsetWidth,
n=this._$wrapper.offsetWidth,o=Math.round(n/a);
this._widthItem=a,this._widthWrapper=n,
...
{var l=r.length-1,d=100*-r.length;r[l].dataset.order=-1,
r[l].dataset.translate=100*-r.length,r[l].style.transform="translateX("+d+"%)",
...
{var t=this._$root,i=this._$items,e=this._config;function s(t){this._autoplay("stop");
var i=0===t.type.search("touch")?t.touches[0]:t;
this._swipeStartPos=i.clientX,
this._hasSwipeState=!0}function r(t){if(this._hasSwipeState)
